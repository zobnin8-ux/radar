...
| **Вс** 10:00 | 🔮 GitHub-сигналы | `/github` | `0 10 * * 0` |
...
| **Radar** | **Вс 10:00** локально | Скачивает JSON → посты в канал |

```text
Сб 21:00 МСК  →  GitTrend push JSON
Вс 10:00 МСК  →  Radar fetch → enrich → Telegram
```
...
4. **Воскресенье 10:00:** Radar → «GitHub-сигналы»; **11:00** — «Направление недели»
...
| 2026-06-14 | GitTrend: сб 21:00 МСК → Radar вс 10:00; коробка 10:20 |
